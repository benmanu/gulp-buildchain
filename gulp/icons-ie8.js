...
var gulpicon_config = {
    ...
    // CSS filenames
    datasvgcss: 'icons.data.svg-ie8.css',
    datapngcss: 'icons.data.png-ie8.css',
    urlpngcss: 'icons.fallback-ie8.css',
    ...
    template: src + '/default-css-ie8.hbs',
    previewTemplate: src + '/preview-custom.hbs',

    compressPNG: true
};

gulp.task('icons:ie8', ['icons:default'], gulpicon(files, gulpicon_config));
